...
const Seemagic = () => {
  ...
  return (
    <div>
      ...
      <div className="text-center p-4 mb-30">
        <input onChange={ e => removeBg(e.target.files[0])} type="file" accept='image/*' id="upload2" hidden />
        <label
          htmlFor="upload2"
          className="inline-flex gap-3 px-8 py-3.5 cursor-pointer bg-linear-to-r from-violet-600 to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700">
